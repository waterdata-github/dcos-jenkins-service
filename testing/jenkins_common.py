...
def cleanup_jenkins_install(service_name, **kwargs):
    ...
    try:
        ...
        jenkins.uninstall(service_name,
                          ...
                          **kwargs)
        log.info("Deleting Service Accounts {}.".format(service_name))
        sdk_security.delete_service_account(ACCOUNTS[service_name]["sa_name"], 
                                            ACCOUNTS[service_name]["sa_secret"],
                                            service_name)
